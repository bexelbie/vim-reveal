...
if !exists('g:vim_reveal_loaded') || g:vim_reveal_loaded == 0
  ...
  let s:default_config = {
              ...
              \'author': 'author',
              \'path': $HOME.'/reveal.js/',
              \'outputPathDirname': 'presentations/',
              \'revealWebPath': '..\/',
              \'dependencies': '',
              \'description': 'This presentation is generated by vim-reveal and reveal.js.'}

  if has_key(g:reveal_config, 'dependencies')
     let g:reveal_config.dependencies = "{ src: '" . g:reveal_config.dependencies . "' },"
  endif
  ...
  function! s:Md2Reveal(...)
    ...
    let s:output_path = has_key(g:reveal_config, 'outputPathDirname')
          \             ? g:reveal_config.outputPathDirname
          \             : s:default_config.outputPathDirname
    let s:output_path = s:root_path . s:output_path
